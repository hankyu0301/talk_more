...
public interface MessageRepository extends JpaRepository<Message, Long> {
    ...
    Slice<MessageSimpleDto> findAllBySenderIdOrderByMessageIdDesc(Long senderId, Long targetId, String keyword,  Pageable pageable);
    ...
    Slice<MessageSimpleDto> findAllByReceiverIdOrderByMessageIdDesc(Long receiverId, Long targetId, String keyword, Pageable pageable);
